...
<header class="bg-[var(--color-background-card)] shadow-sm">
  ...
  <nav class="flex items-center space-x-6">
      ...
      <a href="https://github.com/julianyaman" class="text-[var(--color-secondary-text)] hover:text-[var(--color-primary-accent)] transition-colors" target="_blank" rel="noopener noreferrer" title="GitHub">
